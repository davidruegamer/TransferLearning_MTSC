...
KerasArchitectureInceptionNet = R6::R6Class("KerasArchitectureInceptionNet",
  ...
  public = list(
    initialize = function(build_arch_fn = build_inceptionnet) {
      ...
      param_set$values = list(depth = 3L, filters = 8L, lr = .00001, epochs = 1000L, use_residual = TRUE,
...
KerasArchitectureFCN = R6::R6Class("KerasArchitectureFCN",
  ...
  public = list(
    initialize = function(build_arch_fn = build_fcnet) {
      ...
      param_set$values = list(filters = 128L, lr = .00001, epochs = 1000L, patience=50)
...
LearnerClassifKerasFDA = R6::R6Class("LearnerClassifKerasFDA", inherit = LearnerClassif,
  public = list(
    architecture = NULL,
    initialize = function(
        id = "classif.kerasfda",
      ...
      param_set$values = list(callbacks = list(), validation_split = 0, augmentation_ratio = 4L,
        ...
        center = TRUE, scale = TRUE, batch_size = 128L, seed = 444L
      )

      super$initialize(
        id = assert_character(id, len = 1L),
        param_set = ParamSetCollection$new(list(param_set, self$architecture$param_set)),
